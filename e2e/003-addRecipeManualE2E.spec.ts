...
test('can add recipe including sections, ingredients and instructions in sections', async ({ page }) => {
    // from the homepage, use the nav bar to navigate to the 'Add Recipe' page
    await page.getByRole('link', { name: 'Add Recipe' }).click();
    // click on the button to add a recipe manually
    await page.getByRole('button', { name: 'Add Recipe Manually →' }).click();
    // add a recipe title
    await page.getByRole('textbox', { name: 'Recipe Title' }).click();
    await page.getByRole('textbox', { name: 'Recipe Title' }).fill('recipe with sections');
    ...
    await page.locator('textarea[name="recipeSections.1.sectionName"]').fill('Section 2');
    await page.getByRole('button', { name: 'Add a Section' }).click();
    await page.locator('div:nth-child(4) > .MuiFormControl-root > .MuiInputBase-root').click();
    await page.locator('textarea[name="recipeSections.2.sectionName"]').fill('Section 3');
    ...
    await page.getByRole('combobox', { name: 'teaspoon / tsp' }).nth(1).fill('cup');
    ...
    await page.getByRole('option', { name: 'chicken stock' }).click();
    // click the 'Next' button - navigates to the instructions page
    await page.getByRole('button', { name: 'Next' }).click();
    ...
    await page.getByRole('button', { name: 'Add an Instruction' }).click();
    await page.locator('textarea[name="instructions.1.instructionText"]').click();
    await page.locator('textarea[name="instructions.1.instructionText"]').fill('step 2');
    await page.getByLabel('', { exact: true }).click();
    await page.getByRole('option', { name: 'Section 2' }).click();
    await page.getByRole('button', { name: 'Add an Instruction' }).click();
    // add an instruction
    ...
    await page.getByRole('button', { name: 'delete' }).nth(3).click();
    await page.locator('textarea[name="instructions.2.instructionText"]').click();
    await page.locator('textarea[name="instructions.2.instructionText"]').fill('step 3');
    await page.getByLabel('', { exact: true }).click();
    await page.getByRole('option', { name: 'Section 3' }).click();
    ...
    await expect(page.locator('#root')).toMatchAriaSnapshot(`- text: Recipe Saved!`);
    // click the 'Search' button in the nav bar
    await page.getByRole('link', { name: 'Search' }).click();
    // select 'recipe with sections' card
    await page.getByRole('button', { name: 'recipe with sections' }).click();
...
test('can add recipe including sections, only ingredients in sections', async ({ page }) => {
    // from the homepage, use the nav bar to navigate to the 'Add Recipe' page
    await page.getByRole('link', { name: 'Add Recipe' }).click();
    // click on the button to add a recipe manually
    await page.getByRole('button', { name: 'Add Recipe Manually →' }).click();
    // add a recipe title
    await page.getByRole('textbox', { name: 'Recipe Title' }).click();
    await page.getByRole('textbox', { name: 'Recipe Title' }).fill('recipe with only ingredients in sections');
    // select the radio button for 'Yes' the recipe has sections
    await page.getByRole('radio', { name: 'Yes' }).check();
    // click the 'Next' button - navigates to the tags page
    await page.getByRole('button', { name: 'Next' }).click();
    ...
    await page.getByRole('button', { name: 'Add an Ingredient' }).click();
    await page.getByRole('button', { name: 'Add an Ingredient' }).click();
    await page.locator('[id="mui-component-select-ingredients.0.sectionName"]').click();
    await page.getByRole('option', { name: 'section 1' }).click();
    ...
    await page.getByRole('combobox', { name: 'Select Unit Select Unit' }).fill('tab');
    ...
    await page.getByRole('button', { name: 'Add an Ingredient' }).click();
    await page.getByRole('button', { name: 'Add an Ingredient' }).click();
    await page.locator('[id="mui-component-select-ingredients.2.sectionName"]').click();
    await page.getByRole('option', { name: 'section 2' }).click();
    await page.locator('input[name="ingredients.2.quantity"]').click();
    await page.locator('input[name="ingredients.2.quantity"]').fill('1');
    await page.locator('input[name="ingredients.2.quantity"]').press('Tab');
    ...
    await page.getByRole('combobox', { name: 'teaspoon / tsp' }).nth(2).click();
    await page.getByRole('combobox', { name: 'teaspoon / tsp' }).nth(2).fill('cup');
    await page.getByRole('option', { name: 'cup', exact: true }).click();
    await page.locator('#ingredient-input-3').click();
    ...
    await page.getByRole('button', { name: 'recipe with only ingredients' }).click();
    // assert the recipe contains the expected sections
    await expect(page.locator('#root')).toMatchAriaSnapshot(`
        - heading "recipe with only ingredients in sections" [level=3]
        - heading [level=6]
