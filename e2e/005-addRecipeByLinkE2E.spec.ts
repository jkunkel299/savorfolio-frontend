...
test("can add a new recipe by link", async ({ page }) => {
  ...
  await page
    .getByRole("textbox", { name: "Add a URL here" })
    .fill("https://www.gimmesomeoven.com/mushroom-stroganoff");
  ...
  await page
    .locator('textarea[name="ingredients.1.qualifier"]')
    .fill("divided");
  await page.getByRole("button", { name: "Add an Ingredient" }).click();
  ...
  await page
    .locator('textarea[name="ingredients.2.qualifier"]')
    .fill("thinly sliced");
  await page.getByRole("button", { name: "Add an Ingredient" }).click();
  ...
  await page
    .locator(
      ".MuiInputBase-root.MuiOutlinedInput-root.MuiInputBase-colorPrimary.MuiInputBase-fullWidth.Mui-focused > #units-selection"
    )
    .fill("cup");
  ...
  await page
    .locator('textarea[name="ingredients.9.qualifier"]')
    .fill("fresh, or 1/4 tsp dried");
  await page.getByRole("button", { name: "Add an Ingredient" }).click();
  ...
  await page
    .locator('textarea[name="ingredients.10.qualifier"]')
    .fill("or light sour cream");
  await page.getByRole("button", { name: "Add an Ingredient" }).click();
  ...
  await page
    .locator('textarea[name="ingredients.11.qualifier"]')
    .fill("Kosher");
  await page.getByRole("button", { name: "Add an Ingredient" }).click();
  ...
  await page
    .locator('textarea[name="ingredients.12.qualifier"]')
    .fill("freshly cracked");
  await page.locator('textarea[name="ingredients.12.qualifier"]').click();
  await page
    .locator('textarea[name="ingredients.12.qualifier"]')
    .press("ArrowLeft");
  ...
  await page
    .locator('textarea[name="ingredients.13.qualifier"]')
    .fill("freshly-grated");
  await page.getByRole("button", { name: "Add an Ingredient" }).click();
  ...
  await page
    .locator('textarea[name="ingredients.14.qualifier"]')
    .fill("chopped fresh");
...
test("can see the recipe added", async ({ page }) => {
  ...
  await expect(page.locator('#root')).toMatchAriaSnapshot(`
    - 'link /Mushroom Stroganoff \\(Vegetarian\\) Servings: 4-6 Prep Time: \\d+ minutes Cook Time: \\d+ minutes/':
      - /url: /view/7/mushroom-stroganoff-vegetarian
